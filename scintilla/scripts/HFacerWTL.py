		...
		if v["Category"] != "Deprecated":
			...
			if v["FeatureType"] in ["fun", "get", "set"]:
				...
				if v["Param2Type"] == "stringresult":
					if param1Name == "length" and v["Param1Type"] == "int":
						out.append("\tint " + name + "(CSimpleStringA& strText)" + (" const" if v["FeatureType"] == "get" else ""))
						out.append("\t{")
						out.append("\t\tint nLength;")
						out.append("\t\tLPSTR pszText;")
						out.append("")
						out.append("\t\tnLength = " + name + "Length();")
						out.append("\t\tpszText = strText.GetBuffer(nLength+1);")
						out.append("\t\tnLength = " + name + "(nLength+1, pszText);")
